...
floor_symbol_map = {
    'Basement': 'B', 'Bs': 'B',
    'Ground Floor': 'GF', 'Ground Mezanin': 'GM',
    'First Floor': '1', 'First Mezzanine Floor': '1M',
    'Second Floor': '2', 'Second Mezzanine Floor': '2M',
    'Third Floor': '3', 'Third Mezzanine Floor': '3M',
    'Fourth Floor': '4', 'Fifth Floor': '5', 'Sixth Floor': '6',
    'Seventh Floor': '7', 'Eighth Floor': '8', 'Ninth Floor': '9',
    'Rf': 'R', 'Roof Floor': 'R'
}
...
def run_project1():
    uploaded_file = st.file_uploader("اختر ملف PDF للمطاف", type=["pdf"])
    if uploaded_file:
